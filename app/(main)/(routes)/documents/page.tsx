...
const Documents = () => {
  ...
  //   const promise = restoreDocument({ id: documentId as Id<"documents"> });
  ...
  //   const promise = removeDocument({ id: documentId as Id<"documents"> });
  ...
  if (documents.length === 0) {
    return (
      <div className="p-8 text-center ">
        ...
        <p className="mb-4">Start by creating your first note!</p>
